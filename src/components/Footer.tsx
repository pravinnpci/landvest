...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="bg-[#111827] text-white border-t border-gray-800">
      {/* Top Value Banner */}
      <div className="border-b border-gray-800 py-6 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#68D800] text-black flex items-center justify-center font-black">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-3.5 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-xl text-xs font-bold transition-colors flex items-center gap-1.5"
            >
              <UserCheck className="w-3.5 h-3.5 text-[#68D800]" />
              <span>Seller Login</span>
            </button>
            <button
              onClick={onOpenAdminPortal}
              className="px-3.5 py-2 bg-[#68D800] hover:bg-[#5bc200] text-black rounded-xl text-xs font-black transition-colors flex items-center gap-1.5"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-[#68D800] text-black flex items-center justify-center">
            ...
            <div className="pt-2 text-xs space-y-2 text-gray-300">
              ...
              <div className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 text-[#68D800]" />
        ...
        <div className="mt-12 pt-6 border-t border-gray-800 text-[11px] text-gray-500 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div>
          ...
          <div className="text-gray-400 text-center sm:text-right">
            <span>Admin Editable Branding • High-Yield Prediction Architecture</span>
          </div>
        </div>
      </div>
    </footer>
